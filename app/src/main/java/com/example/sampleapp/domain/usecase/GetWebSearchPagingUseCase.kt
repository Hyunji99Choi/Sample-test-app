...
class GetWebSearchPagingUseCase @Inject constructor(
    ...
    operator fun invoke(search: String, sort: SortType, type: CategoryType): Flow<PagingData<ItemData>> {
        return repository.getWebSearchPagingData(search, sort, type).flow
    }
}